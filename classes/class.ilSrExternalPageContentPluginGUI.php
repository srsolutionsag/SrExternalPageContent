...
class ilSrExternalPageContentPluginGUI extends ilPageComponentPluginGUI
{
    ...
    public function __construct()
    {
        ...
        $this->ui->mainTemplate()->addJavaScript(
            './Customizing/global/plugins/Services/COPage/PageComponent/SrExternalPageContent/assets/js/content.js?version=4'
        );
        $this->ui->mainTemplate()->addCss(
            './Customizing/global/plugins/Services/COPage/PageComponent/SrExternalPageContent/assets/css/content.css?version=4'
        );
